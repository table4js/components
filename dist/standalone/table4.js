(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Table4", [], factory);
	else if(typeof exports === 'object')
		exports["Table4"] = factory();
	else
		root["Table4"] = factory();
})(self, () => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.tableWidgetTemplate = exports.KnockoutHashTableStorage = exports.KnockoutInstance = void 0;
...
exports.tableWidgetTemplate = __webpack_require__(/*! ./table/index.html */ "./sources/knockout/table/index.html")["default"];
ko.components.register("abris-components-table", {
    viewModel: {
        createViewModel: function (params, componentInfo) {
            var widgetModel = params.model;
            widgetModel.initialize(componentInfo.element);
            return widgetModel;
        }
    },
    template: exports.tableWidgetTemplate
});
function renderTableWidget(element) {
    var el = element;
...
table_1.TableWidget.prototype["render"] = renderTableWidget;
